...
def _get_sessions_dir() -> Path:
    ...
    try:
        ...
        return Path(os.environ.get("NERMES_HOME", Path.home() / ".nermes")) / "sessions"
...
class EventBridge:
    ...
    def _poll_once(self, db):
        ...
        try:
            ...
            db_file = Path(os.environ.get("NERMES_HOME", Path.home() / ".nermes")) / "state.db"
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    ...
    mcp = FastMCP(
        "hermes",
        instructions=(
            "Nermes Agent messaging bridge. Use these tools to interact with "
