...
Loads environment variables from ``~/.nermes/.env``, configures logging
...
def _load_env() -> None:
    """Load .env from NERMES_HOME (default ``~/.nermes``)."""
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--setup-browser",
        action="store_true",
        help="Install agent-browser + Playwright Chromium into ~/.nermes/node/ "
