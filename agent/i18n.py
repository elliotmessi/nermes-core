...
Language resolution order:
    ...
    2. ``NERMES_LANGUAGE`` or ``HERMES_LANGUAGE`` environment variable (for tests / quick override)
...
def get_language() -> str:
    ...
    env_lang = os.environ.get("NERMES_LANGUAGE") or os.environ.get("HERMES_LANGUAGE")
    if env_lang:
