...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Nermes"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Nermes"
...
class SkinConfig:
    ...
    banner_hero: str = ""    # Rich-markup hero art (replaces NERMES_MASCOT)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Nermes",
            "welcome": "Welcome to Nermes (牛马)! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
