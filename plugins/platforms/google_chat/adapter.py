...
#     fresh "Nermes is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Nermes is thinking…".
    ...
    def _bot_id_cache_path(self) -> _Path:
        ...
        base = os.getenv("NERMES_HOME", str(_Path.home() / ".nermes"))
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Nermes is thinking…' marker message.
        ...
        "Nermes is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "Nermes is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Nermes is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Nermes is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Nermes is thinking…" card during any subsequent
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # the "Nermes is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Nermes is thinking…' marker message "
